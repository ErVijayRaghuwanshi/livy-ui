...
export default function SettingsTab({ theme, toggleTheme, setShowConnectionModal }) {
  ...
  const settingDefinitions = [
    ...
    },
    {
      ...
      category: "editor",
      breadcrumb: "Text Editor > SQL > Static Validation",
      title: "SQL Static Validation",
      description: "Controls real-time static SQL syntax checking and error squigglies in Monaco Editor.",
      type: "boolean",
      commonlyUsed: true,
    },
    {
      ...
      category: "editor",
      breadcrumb: "Text Editor > SQL > Dialect",
      title: "SQL Validation Dialect",
